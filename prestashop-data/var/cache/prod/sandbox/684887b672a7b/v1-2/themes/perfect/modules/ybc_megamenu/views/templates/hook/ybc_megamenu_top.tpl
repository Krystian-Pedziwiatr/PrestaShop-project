...
{if $menus}
    <div class="ybc-menu-wrapper{if $fixedPositionFull} fixed-full{/if} 
        ...
        {if isset($tc_config.YBC_TC_LAYOUT) && $tc_config.YBC_TC_LAYOUT == 'LAYOUT2' || $tc_config.YBC_TC_LAYOUT == 'LAYOUT3'}<div class="container">{/if}
        ...
        {if isset($tc_config.YBC_TC_LAYOUT) && $tc_config.YBC_TC_LAYOUT == 'LAYOUT2' || $tc_config.YBC_TC_LAYOUT == 'LAYOUT3'}</div>{/if}
