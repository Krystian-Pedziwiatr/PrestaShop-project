	...
	<div class="primary_block row product_layout_1">
		...
		<div class="pb-center-column col-xs-12 col-sm-6">
			...
			<div id="oosHook"{if $product->quantity > 0} style="display: none;"{/if}>
    			...
    			<form id="buy_block" class="{if $PS_CATALOG_MODE && !isset($groups) && $product->quantity > 0} hidden{/if}" action="{$link->getPageLink('cart')|escape:'html':'UTF-8'}" method="post" target="_top">
    				<!-- hidden datas -->
    				<p class="hidden">
                            ...
                            <div class="box-cart-bottom">
        						<div{if (!$allow_oosp && $product->quantity <= 0) || !$product->available_for_order || (isset($restricted_country_mode) && $restricted_country_mode) || $PS_CATALOG_MODE} class="unvisible"{/if}>
        							<p id="add_to_cart" class="buttons_bottom_block no-print">
        								<button type="submit" name="Submit" class="exclusive" target="_top">
