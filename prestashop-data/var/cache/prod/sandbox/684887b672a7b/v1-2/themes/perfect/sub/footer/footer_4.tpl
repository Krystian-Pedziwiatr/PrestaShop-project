                    ...
                    <div class="container">                    
                        ...
                        <ul class="social_footer_bottom">
                            {if (isset($tc_config.BLOCKSOCIAL_FACEBOOK) && $tc_config.BLOCKSOCIAL_FACEBOOK != '')}
                                <li class="facebook">
                    				<a href="{$tc_config.BLOCKSOCIAL_FACEBOOK|escape:html:'UTF-8'}">
                            ...
                            {if (isset($tc_config.BLOCKSOCIAL_TWITTER) && $tc_config.BLOCKSOCIAL_TWITTER != '')}
                                <li class="twitter">
                    				<a href="{$tc_config.BLOCKSOCIAL_TWITTER|escape:html:'UTF-8'}">
                            ...
                            {if (isset($tc_config.BLOCKSOCIAL_GOOGLE_PLUS) && $tc_config.BLOCKSOCIAL_GOOGLE_PLUS != '')}
                                <li class="google-plus">
                    				<a href="{$tc_config.BLOCKSOCIAL_GOOGLE_PLUS|escape:html:'UTF-8'}">
                            ...
                            {if (isset($tc_config.BLOCKSOCIAL_RSS) && $tc_config.BLOCKSOCIAL_RSS != '')}
                                <li class="rss">
                    				<a href="{$tc_config.BLOCKSOCIAL_RSS|escape:html:'UTF-8'}">
                    					<i class="icon-rss"></i>
                    				</a>
                    			</li>
                            {/if}
