...
class Ybc_themeconfig extends Module
{
    ...
    public function __construct()
	{
		...
		$this->displayName = $this->l('YBC Theme options');
       ...
       $this->configs = array(
				...
				'options' => array(
        			 'query' => array( 
                            array(
                                ...
                                'slides' => array(2,3),
                                'widgets' => array(1,2,3,4,14,43,21,22,23,24,19,35,36,37,38,39),
                                'blogs' => array(1,2,3,4),
                            ...
                            array(
                                ...
                                'slides' => array(5,6),
                                'widgets' => array(2,14,42,5,6,7,8,9,25,20,21,22,23,24),
                                'blogs' => array(12,13,14,15),
                                'products' => array(26,27,28,29,30,31,32,33),
                                'menus' => array(1,7,5,8,11,12,13,18),
                            ),
                            array(
                                'id_option' => 'LAYOUT3', 
                                'name' => $this->l('Home page 3'),
                                'slides' => array(7,8),
                                'widgets' => array(2,14,15,41,21,22,23),
                                'blogs' => array(8,9,10,11),
                                'products' => array(18,19,20,21,22,23,24,25),
                                'menus' => array(1,2,3,4,5,8,9,11,14,15),
                            ),
                            ...
                            array(
                                ...
                                'slides' => array(1,4),
                                'widgets' => array(44,45,46,1,2,3,4,14,21,22,23,24,19,35,36,37,38,39),
                                'blogs' => array(5,6,7,8),
                                'products' => array(10,11,12,13,14,15,16,17),
                                'menus' => array(1,2,5,8,16,17), 
                            ),
				...
				'options' => array(
        			 'query' => array(
                            array(
                                ...
                                'main_color' => '#db3a1c',
                                'colors' => array(
                                    'color1' => '#db3a1c',  /* color default */                                  
                                    'color2' => '#ffffff',
                                    'color3' => '#ed3f1f',/* color hover */                                    
                                    'color4' => '#69d2e7', /* color testimonial, copyright, mail contact at footer*/   
                                    'color5' => '#7bced0', 
                                    'color6' => '#db3a1c',
                                    'color7' => '#fcd059',                                
                                ),
                            ...
                            array(
                                ...
                                'main_color' => '#00c2ba',
                                'colors' => array(
                                    'color1' => '#00c2ba',/* color default */
                                    'color2' => '#ffffff',/* color hover */
                                    'color3' => '#05d7ce',/* color hover */                                    
                                    'color4' => '#db3a1c',    
                                    'color5' => '#00c2ba', 
                                    'color6' => '#db3a1c',
                                    'color7' => '#a72c00',                            
                            ...
                            array(
                                ...
                                'main_color' => '#ff446e',
                                'colors' => array(
                                    'color1' => '#ff446e',/* color default */
                                    'color2' => '#ffffff',/* color hover */
                                    'color3' => '#ff6588',/* color hover */                                    
                                    'color4' => '#00c2ba',    
                                    'color5' => '#00c2ba', 
                                    'color6' => '#ff446e',
                                    'color7' => '#a72c00',                            
                            ...
                            array(
                                'id_option' => 'DARK_GREEN', 
                                'name' => $this->l('Dark green'),
                                'main_color' => '#6c8672',
                                'colors' => array(
                                    'color1' => '#6c8672',/* color default */
                                    'color2' => '#ffffff',/* color hover */
                                    'color3' => '#7c9983',/* color hover */                                    
                                    'color4' => '#ff446e',    
                                    'color5' => '#00c2ba', 
                                    'color6' => '#ff446e',
                                    'color7' => '#a72c00',                            
            ...
            'YBC_TC_ENABLE_BANNER' => array(                
                ...
                'group' => 'ybc_tab_home',  
                'default' => 0, 
                'desc' => $this->l('For home home page 3 only'), 
            ), 
            ...
            'YBC_TC_PARALLAX_NEWSLETTER_BG_LAYOUT2' => array(
                'label' => $this->l('Newsletter background layout2'),
                'type' => 'file',
                'default' => 'bg_nlt.jpg',
                'body_class' => false, 
                'group' => 'ybc_tab_footer',           
            ...
            'YBC_TC_TITLE_HOT_DEAL' => array(                
                'label' => $this->l('Title'),
                'type' => 'text',
                'lang' => true,
                'group' => 'ybc_hot_deal',      
                'default' => $this->l('Shop daily deals'),       
            ),    
            'YBC_TC_SUBTITLE_HOT_DEAL' => array(                
                'label' => $this->l('Sub Title'),
                'type' => 'text',
                'lang' => true,
                'default' => 'Get <span class="change_color">20%</span> off all products',
                'group' => 'ybc_hot_deal',                 
            ),             
            'YBC_TC_DATEFROM'=>array(
                'type' => 'date',
                ...
                'desc' => $this->l('Available date begin discount product'),
            ),
            'YBC_TC_DATETO'=>array(
                'type' => 'date',
                ...
                'required' => true,
                'group' => 'ybc_hot_deal',
                'default' =>  date('Y-m-d',time()+100*3600*24),
                'desc' => $this->l('End date discount product'),
            ),
            'YBC_TC_URL_HOT_DEAL' => array(                
                'label' => $this->l('Url'),
                'type' => 'text',
                'lang' => true,
                'default' => '#',
            ...
            'YBC_TC_BG_HOT_DEAL' => array(
                'label' => $this->l('Hot deal background'),
                'type' => 'file',
                'default' => 'hotdeal-1.png',
                'body_class' => false, 
                'group' => 'ybc_hot_deal',           
            ),
            'YBC_TC_DES_HOT_DEAL' => array(                
                'label' => $this->l('Description'),
                'type' => 'textarea',
                'lang' => true,
                'group' => 'ybc_hot_deal',                 
            ),
            'YBC_TC_ENAB_HOT_DEAL' => array(                
            ...
            'YBC_TC_COPYRIGHT_TEXT' => array(                
                ...
                'type' => 'textarea',
                'group' => 'ybc_tab_footer',                
                'default' => 'Copyright � 2016 <a href="http://yourbestcode.com">Your company</a>, All rights reserved.',
            ), 
            ...
            'YBC_TC_CONTACTINFOS_BG' => array(                
                'label' => $this->l('background contact'),
                'type' => 'file',
                'group' => 'ybc_tab_contact',
                'default' => 'contact_bg.png'
            ),
    ...
    public function hookYbcHotDeal()
    {
        
        if((int)Configuration::get('YBC_TC_ENAB_HOT_DEAL')){
            $this->context->controller->addJS($this->_path.'js/jquery.countdown.min.js');
            $this->smarty->assign(array(
                'ybcDev' => $this->devMode,
            ));
            return $this->display(__FILE__, 'hotdeal.tpl');
        }
    ...
    public function hookYbcLayoutUpdate($params)
    {
        ...
        {            
            ...
            {                
                if(strtoupper($config['id_option']) == Tools::strtoupper($layout))
                {                    
