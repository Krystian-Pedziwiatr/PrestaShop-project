...
class Ybc_newsletter extends Module
{
    ...
    public function __construct()
	{
		...
		parent::__construct();
        $this->displayName = $this->l('YBC Newsletter popup');
        ...
        $this->templates = array(
            ...
            'ynpt6' => array(
                ...
                'YBC_NEWSLETTER_POPUP_BUTTON_TEXT_COLOR' => '#ffffff',
                'YBC_NEWSLETTER_POPUP_BUTTON_TEXT_HOVER_COLOR' => '#ffffff',
                'YBC_NEWSLETTER_IMAGE' => 'ynpt6.png',
            ), 
            'ynpt7' => array(
                ...
                'YBC_NEWSLETTER_POPUP_BUTTON_TEXT_COLOR' => '#ffffff',
                'YBC_NEWSLETTER_POPUP_BUTTON_TEXT_HOVER_COLOR' => '#ffffff',
                'YBC_NEWSLETTER_IMAGE' => 'ynpt7.png',
            ),     
            'ynpt8' => array(
    ...
    public function getContent()
	{
       ...
       //Render views
       $this->renderConfig(); 
       return $this->_html.'<script type="text/javascript">var ybc_newsletter_module_path=\''.$this->_path.'\';</script><script type="text/javascript" src="'.$this->_path.'js/admin.js"></script>';
    } 
