...
*}
<div class="ybc-newsletter-popup{if $YBC_NEWSLETTER_MOBILE_HIDE} ynp-mobile-hide{/if} {$YBC_NEWSLETTER_TEMPLATE} ybc-mail-wrapper">
    <div class="ynp-div-l1">
        <div class="ynp-div-l2">
            <div class="ynp-div-l3"> 
                ...
                {/if}               
                <form class="ynp-form ynp-form-popup" action="{$YBC_NEWSLETTER_ACTION}" method="post">
                    {if $YBC_NEWSLETTER_TEMPLATE != 'ynpt8'}
                    ...
                    <div class="ynp-inner">
                        <div class="ynp-loading-div">
                            <img class="ynp-loading" src="{$YBC_NEWSLETTER_LOADING_IMG}" alt="{l s='Loading...' mod='ybc_newsletter'}" />
                        </div>
