...
{if $ybcDev == true}
    ...
    <div id="ybc_hot_deal" style="background-image:url('{$tc_module_path}images/config/{$tc_config.YBC_TC_BG_HOT_DEAL}');">
        ...
        <div class="ybc_hot_deal_content">
            ...
            {if (isset($tc_config.YBC_TC_DES_HOT_DEAL) && $tc_config.YBC_TC_DES_HOT_DEAL)}
                <div class="ybc_hot_deal_description">
                    {$tc_config.YBC_TC_DES_HOT_DEAL}
                </div>
            {/if}
            {if (isset($tc_config.YBC_TC_URL_HOT_DEAL) && $tc_config.YBC_TC_URL_HOT_DEAL)}
                <div class="ybc_hot_deal_button">
                    <a class="button" href="{$tc_config.YBC_TC_URL_HOT_DEAL}">{l s='Purchase now' mod='ybc_themeconfig'}</a>
                </div>
            {/if}
        </div>
    </div>    
