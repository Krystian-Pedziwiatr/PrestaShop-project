	...
	<div class="primary_block row product_layout_2">
		...
		<div class="pb-center-column col-xs-12 col-sm-7">
			...
			<div id="oosHook"{if $product->quantity > 0} style="display: none;"{/if}>
                ...
                {/if}
    			<form id="buy_block"{if $PS_CATALOG_MODE && !isset($groups) && $product->quantity > 0} class="hidden"{/if} action="{$link->getPageLink('cart')|escape:'html':'UTF-8'}" method="post" target="_top">
    				<!-- hidden datas -->
    				<p class="hidden">
